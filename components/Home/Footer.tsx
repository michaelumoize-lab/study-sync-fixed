        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <p className="text-muted-foreground text-sm max-w-xs leading-relaxed">
              The private vault for your academic journey. Built for focus, designed for students, and synced across all your devices.
            </p>
            <div className="flex items-center gap-4">
              <Link href="#" className="p-2 bg-secondary/50 rounded-xl text-muted-foreground hover:text-primary transition-colors">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#how-it-works" className="text-muted-foreground hover:text-foreground text-sm transition-colors">
                  How it Works
                </Link>
              </li>
              <li>
